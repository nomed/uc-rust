...
Current baseline: **all 24 P0 rows are at least Defined; 7 rows are Implemented; maturity score 25.8%**. Implemented controls remain below Evidenced until a clean intentional run is observed and linked.
